	...
	UPG: {
		...
		objectdefinition: {
			...
			common: {
				...
				desc: {
					"en": "Request firmware upgrade over internet (WiFi connection must be set)\nEmpty – upgrade to release firmware\nTEST or test – upgrade to SYR test branch firmware\nHGTEST or hgtest – upgrade to HansGrohe test branch firmware",
					"de": "Firmware-Upgrade über das Internet anfordern (WiFi-Verbindung muss eingestellt werden)\nLeer – Upgrade zur Freigabe von Firmware\nTEST oder Test – Upgrade auf SYR-Testzweig Firmware\nHGTEST oder hgtest – Upgrade auf HansGrohe Testzweig Firmware",
					"ru": "Запросить обновление прошивки через интернет (WiFi соединение должно быть установлено)\nEmpty – обновление для выпуска прошивки\nTEST или test — обновление для прошивки SYR тестового филиала\nHGTEST или hgtest – обновление до HansGrohe тестовой прошивки",
					"pt": "Solicitar atualização de firmware através da Internet (a conexão WiFi deve ser definida)\nEmpty – atualizar para liberar firmware\nTEST ou teste – upgrade para o firmware do ramo de teste SYR\nHGTEST ou hgtest – atualize para o firmware do ramo de teste HansGrohe",
					"nl": "Verzoek firmaware upgrade over internet (WiFi verbinding moet worden gezet)\nLeeg om de firmaware vrij te laten\nTEST of test - upgrade to SYR-test firmanchware\nHGTEST of HGTest - upgrade aan HansGrohe test Branch firmaware",
					"fr": "Demande de mise à niveau du firmware sur Internet (La connexion WiFi doit être définie)\nEmpty – mise à niveau pour libérer le firmware\nTEST ou test – mise à niveau du firmware SYR\nHGTEST ou hgtest – mise à niveau du firmware HansGrohe test",
					"it": "Richiedi l'aggiornamento del firmware su Internet (la connessione Wi-Fi deve essere impostata)\nVuoto – aggiornamento del firmware di rilascio\nTEST o test – aggiornamento del firmware SYR\nHGTEST o hgtest – aggiornamento del firmware HansGrohe",
					"es": "Solicitar actualización de firmware a través de Internet (la conexión WiFi debe establecerse)\nVacío: actualización para liberar firmware\nTEST o prueba: actualización al firmware de la rama de prueba SYR\nHGTEST o hgtest – actualización a HansGrohe prueba firmware",
					"pl": "Request functionalware ulepszanie w internecie (WiFi connection)\nEmpty – ulepszanie firmware\nTEST lub test – aktualizacja działu SYR\nHGTEST – modernizacja firmy HansGrohe",
					"uk": "Запит оновлення мікропрограми в Інтернеті (з'єднання WiFi необхідно встановити)\nEmpty – оновлення для релізу прошивки\nTEST або тест - оновлення до прошивки SYR\nHGTEST або hgtest - оновлення до прошивки HansGrohe",
					"zh-cn": "要求在互联网上升级(必须建立WiFi联系)\n加速释放警觉\n技术或试验单元升级\nHGTTS or hgert en to HansGrohe试验组"
				},
				type: 'string',
				unit: null,
				role: 'state',
