	...
	BatteryMeasurementPeriod: {
		...
		objectdefinition: {
			...
			common: {
				...
				desc: {
					"en": "(12*3600)s (12h) - Should be equal to Report Connection Period for best battery utilisation",
					"de": "(12*3600)s (12h) - Sollte gleich wie die Messperiode der Batterie sein für beste Batterieauslastung",
					"ru": "(12*3600)s (12h) - Должен быть равным периоду соединения отчета для лучшего использования батареи",
					"pt": "(12*3600)s (12h) - Deve ser igual ao Período de Conexão de Relatório para melhor utilização da bateria",
					"nl": "(12*3600)s (12h) - Het zou gelijk moeten zijn aan het verslag van de connectie van de beste batterijen",
					"fr": "(12*3600)s (12h) - Devrait être égale à la période de connexion de rapport pour une meilleure utilisation de la batterie",
					"it": "(12*3600)s (12h) - Dovrebbe essere uguale a Report Periodo di connessione per la migliore utilizzazione della batteria",
					"es": "(12*3600)s (12h) - Debe ser igual a Report Connection Periodo para la mejor utilización de batería",
					"pl": "(12*3600)s (12h) - Może być równa z okresem łączeń dla najlepszej baterii",
					"uk": "(12*3600)s (12h) - Чи повинен бутирівняний період зв'язку звіту для кращого утилізації батареї",
					"zh-cn": "(12*3600)s (12h) - 如果等于报告最佳电池的使用权"
				},
				type: 'number',
				unit: 's',
				role: 'value.interval',
