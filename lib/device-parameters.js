...
const DeviceParameters = {
	...
	LeakageNotificationWarningThreshold: {
		...
		objectdefinition: {
			...
			common: {
				name: {
					'en': 'Leakage notification (warning) threshold (88 - 99%)',
					'de': 'Schwellenwert für Leckagebenachrichtigung (Warnung) (88 - 99%)',
					'ru': 'Порог уведомления (предупреждения) об утечке (88 - 99%)',
					'pt': 'Limite de notificação de vazamento (aviso) (88 - 99%)',
					'nl': 'Lekkage melding (waarschuwing) drempel (88 - 99%)',
					'fr': 'Seuil de notification de fuite (avertissement) (88 - 99%)',
					'it': 'Soglia di notifica di perdita (avviso) (88 - 99%)',
					'es': 'Umbral de notificación (advertencia) de fugas (88 - 99%)',
					'pl': 'Próg powiadomienia o wycieku (ostrzeżenie) (88 - 99%)',
					'zh-cn': '泄漏通知（警告）阈值 (88 - 99%)'
				},
				type: 'number',
				unit: '%',
				role: 'state',
