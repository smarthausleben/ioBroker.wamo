	...
	CLRALA: {
		...
		objectdefinition: {
			...
			common: {
				...
				desc: {
					"en": "Clears current alarm, opens valve",
					"de": "Löscht aktuellen Alarm und öffnet das Ventil",
					"ru": "Очищает текущую тревогу, открывает клапан",
					"pt": "Limpa o alarme de corrente, abre a válvula",
					"nl": "Verwijder het huidige alarm, open de klep",
					"fr": "Effacer l'alarme de courant, ouvrir la soupape",
					"it": "Cancella l'allarme corrente, apre la valvola",
					"es": "Limpia la alarma de corriente, abre la válvula",
					"pl": "Nieczyste alarmy, otwarte zastawki",
					"uk": "Очистити поточну сигналізацію, відкриває клапан",
					"zh-cn": "警示当前震惊,露天阀"
				  },
				type: 'boolean',
				unit: null,
