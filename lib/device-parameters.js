...
/**
 * [Objects] Device control states
 */
const deviceControlStates = [
	DeviceParameters.systemRestart
];
...
/**
 * Array of 'DeviceParameter' objects used to control and monitor the main valve
 */
const mainValveParameters = [
...
module.exports = {deviceControlStates, adapterChannels, calculatedStates, StatisticStates, DeviceParameters, initStates, alarmPeriod, shortPeriod, longPeriode, sensorPresence, mainValveParameters};