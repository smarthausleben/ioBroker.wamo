...
const DeviceParameters = {
	...
	WFK: {
		...
		objectdefinition: {
			...
			common: {
				...
				desc: {
					"en": "WIFI key 8-64 characters",
					"de": "WIFI Schlüssel 8-64 Zeichen",
					"ru": "WIFI ключ 8-64 символа",
					"pt": "Chave de WIFI 8-64 caracteres",
					"nl": "WIFI toets 8-64 karakters",
					"fr": "Touche WIFI 8-64 caractères",
					"it": "WIFI chiave 8-64 caratteri",
					"es": "WIFI clave 8-64 caracteres",
					"pl": "Klucz 8-64",
					"uk": "WIFI ключ 8-64 символи",
					"zh-cn": "知识产权组织FI 主要86-64特点"
				},
				type: 'string',
				unit: null,
				role: 'state',
		...
		objectdefinition: {
			...
			common: {
				name: {
					...
					"de": "MQTT Wiederverbindungszeit nach Unterbrechung",
				...
				desc:{
					...
					"de": "MQTT Wiederverbindungszeit wenn unterbrochen 0 deaktiviert 1...60min",
		...
		objectdefinition: {
			...
			common: {
				name: {
					...
					"de": "Kalkulationsfaktor für deutsche Wasserhärten",
	...
	WFC: {
		...
		objectdefinition: {
			...
			common: {
				name: {
					"en": "WiFi connect (SSID)",
					"de": "WLAN (SSID)",
					"ru": "Wi-Fi (SSID)",
					"pt": "Wi-Fi (SSID)",
					"nl": "WiFi connectie (SID)",
					"fr": "Connexion WiFi (SSID)",
					"it": "Connessione WiFi (SSID)",
					"es": "Conexión WiFi (SSID)",
					"pl": "WiFi connect (ang.)",
					"uk": "Підключення до Інтернету (SSID)",
					"zh-cn": "WFi 连接(SSID)"
				},
				desc: {
	...
	CLRALA: {
		...
		objectdefinition: {
			...
			common: {
				name: {
					"en": "Clear ongoing alarm",
					"de": "Aktiven Alarm löschen",
					"ru": "Очистить постоянную тревогу",
					"pt": "Alarme contínuo claro",
					"nl": "Duidelijk alarm",
					"fr": "Alarme ouverte",
					"it": "Allarme continuo chiaro",
					"es": "Clear ongoing alarm",
					"pl": "Silny alarm",
					"uk": "Очистити постійний сигнал",
					"zh-cn": "清 警"
				},
				desc: {
					"en": "Clears current alarm, opens valve (set to TRUE to clear alarm)",
					"de": "Quittiert anstehenden Alarm und öffnet das Ventil (auf TRUE setzen um den Alarm zu quittieren)",
					"ru": "Очищает текущую тревогу, открывает клапан (находится на TRUE для ясной тревоги)",
					"pt": "Limpa o alarme de corrente, abre a válvula (definido para TRUE para limpar o alarme)",
					"nl": "Het ontruimt het huidige alarm, opent klep (set om te proberen alarmeren)",
					"fr": "Efface l'alarme de courant, ouvre la soupape (selon TRUE pour effacer l'alarme)",
					"it": "Cancella l'allarme corrente, apre la valvola (imposta a TRUE per allarme chiaro)",
					"es": "Limpia la alarma actual, abre la válvula (ajuste a TRUE para aclarar la alarma)",
					"pl": "Wyraźny alarm, otwierający zawór (kodowane do TRUE by clear alarm)",
					"uk": "Очищає поточну сигналізацію, відкриває клапан (підйом до TRUE для чіткої сигналізації)",
					"zh-cn": "提醒目前震惊的是,开放阀门(TRUE以明确警觉)"
				},
				type: 'boolean',
				unit: null,
				role: 'button',
	...
	PV1: {
		...
		objectdefinition: {
			...
			common: {
				name: {
					'en': 'Quantity limitation',
					'de': 'Mengenbegrenzung',
					'ru': 'Ограничение количества',
					'pt': 'Limitação de quantidade',
					'nl': 'Quantity beperking',
					'fr': 'Limite de la quantité',
					'it': 'Limiti di quantità',
					'es': 'Limitación de la cantidad',
					'pl': 'Granica graniczna)',
					'zh-cn': '资格限制'
				},
				desc: {
					...
					"nl": "Quantity beperking (0) Deaktivatie 1 - 9000l)",
