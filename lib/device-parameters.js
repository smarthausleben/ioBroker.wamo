...
const DeviceParameters = {
	...
	SelfLearningPhase: {
		...
		objectdefinition: {
			...
			common: {
				name: {
					"en": "Self learning phase. 0 Disabled, 1-28 days",
					"de": "Selbstlernende Phase. 0 Behinderte, 1-28 Tage",
					"ru": "Самообучение фазы. 0 Отключено, 1-28 дней",
					"pt": "Fase de auto-aprendizagem. 0 Desativado, 1-28 dias",
					"nl": "Zelf leren fase. Akkoord 1-28 dagen",
					"fr": "Phase d'autoapprentissage. 0 Handicapés, 1-28 jours",
					"it": "Fase di autoapprendimento. 0 Disabili, 1-28 giorni",
					"es": "Fase de aprendizaje propio. 0 Discapacitados, 1-28 días",
					"pl": "Faza uczenia się. Zbliżona do 1-28 dni",
					"zh-cn": "自我学习阶段。 0 残疾人 1-28天"
				},
				type: 'number',
				unit: 'days',
				role: 'state',
