...
const DeviceParameters = {
	...
	SelfLearningOffset: {
		...
		objectdefinition: {
			...
			common: {
				name: {
					'en': 'Self learning values (volume, time) surplus',
					'de': 'Selbstlernende Werte (Volumen, Zeit) Überschuss',
					'ru': 'Значения самообучения (объем, время) излишки',
					'pt': 'Valores de autoaprendizagem (volume, tempo) excedente',
					'nl': 'Zelf leren waarden (volume, tijd)',
					'fr': 'Valeurs d\'autoapprentissage (volume, temps) excédentaire',
					'it': 'Valori di autoapprendimento (volume, tempo) surplus',
					'es': 'Superávit de los valores de autoaprendizaje (volumen, tiempo)',
					'pl': 'Wartość uczenia się (ang.)',
					'zh-cn': '自我学习价值(周转时间)盈余'
				},
				type: 'number',
				unit: '%',
				role: 'state',
	...
	SelfLearningFlowOffset: {
		...
		objectdefinition: {
			...
			common: {
				name: {
					'en': 'Self learning max flow surplus',
					'de': 'Selbstlernen max Flussüberschuss',
					'ru': 'Самое обучение Макс поток излишки',
					'pt': 'Excedente de fluxo máximo de aprendizagem automática',
					'nl': 'Egoïstisch leren',
					'fr': 'Autoapprentissage max débit excédent',
					'it': 'Self learning max flusso surplus',
					'es': 'Superávit de flujo máximo de aprendizaje',
					'pl': 'Same uczenie się przepływu maksimum',
					'zh-cn': '自营职业者'
				},
				type: 'number',
				unit: '%',
